/****************************************************************************
 * arch/arm/src/lpc43xx/stmp3770_usb0dev.h
 *
...
#ifndef __ARCH_ARM_SRC_STMP3770_USB0DEV_H
#define __ARCH_ARM_SRC_STMP3770_USB0DEV_H
...
int stmp3770_usbpullup(FAR struct usbdev_s *dev,  bool enable);

/****************************************************************************
 * Name:  stmp3770_usbsuspend
 *
 * Description:
 *   Board logic must provide the stmp3770_usbsuspend logic if the USBDEV driver
...
void stmp3770_usbsuspend(FAR struct usbdev_s *dev, bool resume);
...
#define STMP3770_USBOTG_HCCR_OFFSET             0x0100 /* Offset to EHCI Host Controller Capability registers */
#define STMP3770_USBOTG_CAPLENGTH_OFFSET        0x0100 /* Capability length register */
#define STMP3770_USBHOST_HCSPARAMS_OFFSET       0x0104 /* Host controller structural parameters */
#define STMP3770_USBHOST_HCCPARAMS_OFFSET       0x0108 /* Host controller capability parameters */
#define STMP3770_USBDEV_DCIVERSION_OFFSET       0x0120 /* Device interface version number */
#define STMP3770_USBDEV_DCCPARAMS_OFFSET        0x0124 /* Device controller capability parameters */

/* Device/host/OTG operational registers */

#define STMP3770_USBOTG_HCOR_OFFSET             0x0140 /* Offset to EHCI Host Controller Operational Registers */
#define STMP3770_USBOTG_USBCMD_OFFSET           0x0140 /* USB command (both) */
#define STMP3770_USBOTG_USBSTS_OFFSET           0x0144 /* USB status (both) */
#define STMP3770_USBOTG_USBINTR_OFFSET          0x0148 /* USB interrupt enable (both) */
#define STMP3770_USBOTG_FRINDEX_OFFSET          0x014c /* USB frame index (both) */
#define STMP3770_USBHOST_PERIODICLIST_OFFSET    0x0154 /* Frame list base address (host) */
#define STMP3770_USBDEV_DEVICEADDR_OFFSET       0x0154 /* USB device address (device) */
#define STMP3770_USBHOST_ASYNCLISTADDR_OFFSET   0x0158 /* Next asynchronous list address (host) */
#define STMP3770_USBDEV_ENDPOINTLIST_OFFSET     0x0158 /* Address of endpoint list in memory (device) */
#define STMP3770_USBHOST_TTCTRL_OFFSET          0x015c /* Asynchronous buffer status for embedded TT (host) */
#define STMP3770_USBOTG_BURSTSIZE_OFFSET        0x0160 /* Programmable burst size (both) */
#define STMP3770_USBHOST_TXFILLTUNING_OFFSET    0x0164 /* Host transmit pre-buffer packet tuning (host) */
#define STMP3770_USBOTG_BINTERVAL_OFFSET        0x0174 /* Length of virtual frame (both) */
#define STMP3770_USBDEV_ENDPTNAK_OFFSET         0x0178 /* Endpoint NAK (device) */
#define STMP3770_USBDEV_ENDPTNAKEN_OFFSET       0x017c /* Endpoint NAK Enable (device) */
#define STMP3770_USBOTG_PORTSC1_OFFSET          0x0184 /* Port status/control 1 (both) */
#define STMP3770_USBOTG_OTGSC_OFFSET            0x01a4 /* OTG status and control (otg) */
#define STMP3770_USBOTG_USBMODE_OFFSET          0x01a8 /* USB device mode (both) */

/* Device side naming of common register offsets */

#define STMP3770_USBDEV_USBCMD_OFFSET           STMP3770_USBOTG_USBCMD_OFFSET
#define STMP3770_USBDEV_USBSTS_OFFSET           STMP3770_USBOTG_USBSTS_OFFSET
#define STMP3770_USBDEV_USBINTR_OFFSET          STMP3770_USBOTG_USBINTR_OFFSET
#define STMP3770_USBDEV_FRINDEX_OFFSET          STMP3770_USBOTG_FRINDEX_OFFSET
#define STMP3770_USBDEV_BURSTSIZE_OFFSET        STMP3770_USBOTG_BURSTSIZE_OFFSET
#define STMP3770_USBDEV_BINTERVAL_OFFSET        STMP3770_USBOTG_BINTERVAL_OFFSET
#define STMP3770_USBDEV_PORTSC1_OFFSET          STMP3770_USBOTG_OTGSC_OFFSET
#define STMP3770_USBDEV_USBMODE_OFFSET          STMP3770_USBOTG_USBMODE_OFFSET

/* Host side naming of common registers */

#define STMP3770_USBHOST_USBCMD_OFFSET          STMP3770_USBOTG_USBCMD_OFFSET
#define STMP3770_USBHOST_USBSTS_OFFSET          STMP3770_USBOTG_USBSTS_OFFSET
#define STMP3770_USBHOST_USBINTR_OFFSET         STMP3770_USBOTG_USBINTR_OFFSET
#define STMP3770_USBHOST_FRINDEX_OFFSET         STMP3770_USBOTG_FRINDEX_OFFSET
#define STMP3770_USBHOST_BURSTSIZE_OFFSET       STMP3770_USBOTG_BURSTSIZE_OFFSET
#define STMP3770_USBHOST_BINTERVAL_OFFSET       STMP3770_USBOTG_BINTERVAL_OFFSET
#define STMP3770_USBHOST_PORTSC1_OFFSET         STMP3770_USBOTG_OTGSC_OFFSET
#define STMP3770_USBHOST_USBMODE_OFFSET         STMP3770_USBOTG_USBMODE_OFFSET

/* Device endpoint registers */

#define STMP3770_USBDEV_ENDPTSETUPSTAT_OFFSET   0x01ac /* Endpoint setup status */
#define STMP3770_USBDEV_ENDPTPRIME_OFFSET       0x01b0 /* Endpoint initialization */
#define STMP3770_USBDEV_ENDPTFLUSH_OFFSET       0x01b4 /* Endpoint de-initialization */
#define STMP3770_USBDEV_ENDPTSTATUS_OFFSET      0x01b8 /* Endpoint status */
#define STMP3770_USBDEV_ENDPTCOMPLETE_OFFSET    0x01bc /* Endpoint complete */

#define STMP3770_USBDEV_ENDPTCTRL_OFFSET(n)     (0x01c0 + ((n) << 2))
#define STMP3770_USBDEV_ENDPTCTRL0_OFFSET       0x01c0 /* Endpoint control 0 */
#define STMP3770_USBDEV_ENDPTCTRL1_OFFSET       0x01c4 /* Endpoint control 1 */
#define STMP3770_USBDEV_ENDPTCTRL2_OFFSET       0x01c8 /* Endpoint control 2 */
#define STMP3770_USBDEV_ENDPTCTRL3_OFFSET       0x01cc /* Endpoint control 3 */
#define STMP3770_USBDEV_ENDPTCTRL4_OFFSET       0x01d0 /* Endpoint control 4 */
//#define STMP3770_USBDEV_ENDPTCTRL5_OFFSET       0x01d4 /* Endpoint control 5 */

/* USB0 register (virtual) addresses ****************************************/

/* Device/host capability registers */
#define STMP3770_USBOTG_HCCR_BASE               (STMP3770_USBOTG_VSECTION+STMP3770_USBOTG_HCCR_OFFSET)
#define STMP3770_USBOTG_CAPLENGTH               (STMP3770_USBOTG_VSECTION+STMP3770_USBOTG_CAPLENGTH_OFFSET)
#define STMP3770_USBHOST_HCIVERSION             (STMP3770_USBOTG_VSECTION+STMP3770_USBHOST_HCIVERSION_OFFSET)
#define STMP3770_USBHOST_HCSPARAMS              (STMP3770_USBOTG_VSECTION+STMP3770_USBHOST_HCSPARAMS_OFFSET)
#define STMP3770_USBHOST_HCCPARAMS              (STMP3770_USBOTG_VSECTION+STMP3770_USBHOST_HCCPARAMS_OFFSET)
#define STMP3770_USBDEV_DCIVERSION              (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_DCIVERSION_OFFSET)
#define STMP3770_USBDEV_DCCPARAMS               (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_DCCPARAMS_OFFSET)

/* Device/host operational registers */
#define STMP3770_USBOTG_HCOR_BASE               (STMP3770_USBOTG_VSECTION+STMP3770_USBOTG_HCOR_OFFSET)
#define STMP3770_USBOTG_USBCMD                  (STMP3770_USBOTG_VSECTION+STMP3770_USBOTG_USBCMD_OFFSET)
#define STMP3770_USBOTG_USBSTS                  (STMP3770_USBOTG_VSECTION+STMP3770_USBOTG_USBSTS_OFFSET)
#define STMP3770_USBOTG_USBINTR                 (STMP3770_USBOTG_VSECTION+STMP3770_USBOTG_USBINTR_OFFSET)
#define STMP3770_USBOTG_FRINDEX                 (STMP3770_USBOTG_VSECTION+STMP3770_USBOTG_FRINDEX_OFFSET)
#define STMP3770_USBHOST_PERIODICLIST           (STMP3770_USBOTG_VSECTION+STMP3770_USBHOST_PERIODICLIST_OFFSET)
#define STMP3770_USBDEV_DEVICEADDR              (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_DEVICEADDR_OFFSET)
#define STMP3770_USBHOST_ASYNCLISTADDR          (STMP3770_USBOTG_VSECTION+STMP3770_USBHOST_ASYNCLISTADDR_OFFSET)
#define STMP3770_USBDEV_ENDPOINTLIST            (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPOINTLIST_OFFSET)
#define STMP3770_USBHOST_TTCTRL                 (STMP3770_USBOTG_VSECTION+STMP3770_USBHOST_TTCTRL_OFFSET)
#define STMP3770_USBOTG_BURSTSIZE               (STMP3770_USBOTG_VSECTION+STMP3770_USBOTG_BURSTSIZE_OFFSET)
#define STMP3770_USBHOST_TXFILLTUNING           (STMP3770_USBOTG_VSECTION+STMP3770_USBHOST_TXFILLTUNING_OFFSET)
#define STMP3770_USBOTG_BINTERVAL               (STMP3770_USBOTG_VSECTION+STMP3770_USBOTG_BINTERVAL_OFFSET)
#define STMP3770_USBDEV_ENDPTNAK                (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTNAK_OFFSET)
#define STMP3770_USBDEV_ENDPTNAKEN              (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTNAKEN_OFFSET)
#define STMP3770_USBOTG_PORTSC1                 (STMP3770_USBOTG_VSECTION+STMP3770_USBOTG_PORTSC1_OFFSET)
#define STMP3770_USBOTG_OTGSC                   (STMP3770_USBOTG_VSECTION+STMP3770_USBOTG_OTGSC_OFFSET)
#define STMP3770_USBOTG_USBMODE                 (STMP3770_USBOTG_VSECTION+STMP3770_USBOTG_USBMODE_OFFSET)

/* Device side naming of common register offsets */

#define STMP3770_USBDEV_USBCMD                  STMP3770_USBOTG_USBCMD
#define STMP3770_USBDEV_USBSTS                  STMP3770_USBOTG_USBSTS
#define STMP3770_USBDEV_USBINTR                 STMP3770_USBOTG_USBINTR
#define STMP3770_USBDEV_FRINDEX                 STMP3770_USBOTG_FRINDEX
#define STMP3770_USBDEV_BURSTSIZE               STMP3770_USBOTG_BURSTSIZE
#define STMP3770_USBDEV_BINTERVAL               STMP3770_USBOTG_BINTERVAL
#define STMP3770_USBDEV_PORTSC1                 STMP3770_USBOTG_OTGSC
#define STMP3770_USBDEV_USBMODE                 STMP3770_USBOTG_USBMODE

/* Host side naming of common registers */

#define STMP3770_USBHOST_USBCMD                 STMP3770_USBOTG_USBCMD
#define STMP3770_USBHOST_USBSTS                 STMP3770_USBOTG_USBSTS
#define STMP3770_USBHOST_USBINTR                STMP3770_USBOTG_USBINTR
#define STMP3770_USBHOST_FRINDEX                STMP3770_USBOTG_FRINDEX
#define STMP3770_USBHOST_BURSTSIZE              STMP3770_USBOTG_BURSTSIZE
#define STMP3770_USBHOST_BINTERVAL              STMP3770_USBOTG_BINTERVAL
#define STMP3770_USBHOST_PORTSC1                STMP3770_USBOTG_OTGSC
#define STMP3770_USBHOST_USBMODE                STMP3770_USBOTG_USBMODE

/* Device endpoint registers */

#define STMP3770_USBDEV_ENDPTSETUPSTAT          (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTSETUPSTAT_OFFSET)
#define STMP3770_USBDEV_ENDPTPRIME              (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTPRIME_OFFSET)
#define STMP3770_USBDEV_ENDPTFLUSH              (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTFLUSH_OFFSET)
#define STMP3770_USBDEV_ENDPTSTATUS             (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTSTATUS_OFFSET)
#define STMP3770_USBDEV_ENDPTCOMPLETE           (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTCOMPLETE_OFFSET)

#define STMP3770_USBDEV_ENDPTCTRL(n)            (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTCTRL_OFFSET(n))
#define STMP3770_USBDEV_ENDPTCTRL0              (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTCTRL0_OFFSET)
#define STMP3770_USBDEV_ENDPTCTRL1              (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTCTRL1_OFFSET)
#define STMP3770_USBDEV_ENDPTCTRL2              (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTCTRL2_OFFSET)
#define STMP3770_USBDEV_ENDPTCTRL3              (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTCTRL3_OFFSET)
#define STMP3770_USBDEV_ENDPTCTRL4              (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTCTRL4_OFFSET)
//#define STMP3770_USBDEV_ENDPTCTRL5              (STMP3770_USBOTG_VSECTION+STMP3770_USBDEV_ENDPTCTRL5_OFFSET)
...
#endif /* __ARCH_ARM_SRC_LPC43XX_STMP3770_USB0DEV_H */
