...
#  define     STMP3770_USBOTG_PSECTION        0x80080000
...
#  define     STMP3770_USBOTG_VSECTION        0x80080000
...
#define			NUTTX_START_PADDR		0
#define 		NUTTX_START_VADDR 		0
...
#          define PGTABLE_BASE_PADDR (STMP3770_OCSRAM_PADDR + STMP3770_OCSRAM_SIZE - 1 * PGTABLE_SIZE)
//#          define PGTABLE_BASE_VADDR (STMP3770_OCSRAM_VADDR + STMP3770_OCSRAM_SIZE - 1 * PGTABLE_SIZE)
...
#define PGTABLE_L2_COARSE_OFFSET    (0x2800)
...
#define PGTABLE_L2_FINE_OFFSET      (0x2200)
...
#define PGTABLE_L2_END_PADDR        (PGTABLE_BASE_PADDR + 1 * PGTABLE_SIZE)
#define PGTABLE_L2_END_VADDR        (PGTABLE_BASE_VADDR + 1 * PGTABLE_SIZE)
